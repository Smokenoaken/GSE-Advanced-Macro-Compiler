...
local function createBlizzOptions(category)
    ...
    do
        ...
        do
            ...
            local setting = Settings.RegisterProxySetting(troubleOptions, "GSE_useMulticlickButtons", Settings.VarType.Boolean, L["Use MultiClick Buttons"], true, GetValue, SetValue)

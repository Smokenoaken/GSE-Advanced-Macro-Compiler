...
local function createBlizzOptions(category)
    ...
    do
        ...
        do
            local setting = Settings.RegisterAddOnSetting(troubleOptions, "GSE_useMulticlickButtons", "Multiclick", GSEOptions, Settings.VarType.Boolean, L["Use MultiClick Buttons"], true)
